...
--
-- Host: 161.35.10.103    Database: bd_capacitaciones
-- ------------------------------------------------------
...
CREATE TABLE `cursos` (
  ...
  `curso_occ` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `entornoaprendizajescurriculares`
--

DROP TABLE IF EXISTS `entornoaprendizajescurriculares`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `entornoaprendizajescurriculares` (
  `id_entorno_curricular` int NOT NULL AUTO_INCREMENT,
  `estadoEntornoAprendizaje` tinyint(1) DEFAULT NULL,
  `fase_practica` varchar(1200) DEFAULT NULL,
  `fase_feorica` varchar(1200) DEFAULT NULL,
  `instalaciones` varchar(1000) DEFAULT NULL,
  `id_disenio_curricular` int DEFAULT NULL,
  PRIMARY KEY (`id_entorno_curricular`),
  KEY `FK888kn8d3gksqby04e3nkgwes2` (`id_disenio_curricular`),
  CONSTRAINT `FK888kn8d3gksqby04e3nkgwes2` FOREIGN KEY (`id_disenio_curricular`) REFERENCES `diseniocurriculares` (`id_disenio_curricular`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `entornoaprendizajescurriculares`
--

LOCK TABLES `entornoaprendizajescurriculares` WRITE;
/*!40000 ALTER TABLE `entornoaprendizajescurriculares` DISABLE KEYS */;
/*!40000 ALTER TABLE `entornoaprendizajescurriculares` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `hojavidacapacitadores` (
  ...
  `destrezas` varchar(1800) DEFAULT NULL,
  `documento` longblob,
  `estadoAprobacion` varchar(255) DEFAULT NULL,
  `experiencia_escolar` varchar(1800) DEFAULT NULL,
  `experiencial_laboral` varchar(1800) DEFAULT NULL,
  `idiomas` varchar(1200) DEFAULT NULL,
  `sobre_mi` varchar(1800) DEFAULT NULL,
  `id_capacitador` int DEFAULT NULL,
...
CREATE TABLE `participantesaprobados` (
  ...
  `certificado_firmado` tinyint(1) DEFAULT NULL,
  `certificado_participante` longblob,
...
CREATE TABLE `periodos_programas` (
  ...
  `fecha_fin_periodo_programa` date DEFAULT NULL,
  `fecha_inicio_periodo_programa` date DEFAULT NULL,
...
INSERT INTO `personas` VALUES (1,'','','','','','',NULL,'','admin','','admin','','');
...
INSERT INTO `provincias` VALUES (1,'Azuay'),(2,'Bolívar'),(3,'Cañar'),(4,'Carchi'),(5,'Cotopaxi'),(6,'Chimborazo'),(7,'El Oro'),(8,'Esmeraldas'),(9,'Guayas'),(10,'Imbabura'),(11,'Loja'),(12,'Los Rios'),(13,'Manabi'),(14,'Morona Santiago'),(15,'Napo'),(16,'Pastaza'),(17,'Pichincha'),(18,'Tungurahua'),(19,'Zamora Chinchipe'),(20,'Galápagos'),(21,'Sucumbíos'),(22,'Orellana'),(23,'Santo Domingo de Los Tsáchilas'),(24,'Santa Elena'),(25,'Zonas No Delimitadas');
/*!40000 ALTER TABLE `provincias` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pruebaPdfs`
--

DROP TABLE IF EXISTS `pruebaPdfs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pruebaPdfs` (
  `idpruebaPdfs` int NOT NULL AUTO_INCREMENT,
  `exel` longblob,
  `nombre` varchar(255) DEFAULT NULL,
  `pdf` longblob,
  PRIMARY KEY (`idpruebaPdfs`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pruebaPdfs`
--

LOCK TABLES `pruebaPdfs` WRITE;
/*!40000 ALTER TABLE `pruebaPdfs` DISABLE KEYS */;
/*!40000 ALTER TABLE `pruebaPdfs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users_roles` (
  ...
  KEY `FKnyxx7rovkcx58fwx645h5pfdu` (`id_usuario`),
...
INSERT INTO `usuarios` VALUES (1,1,NULL,'$2a$12$Oo/4BABQr4CGc5IlJmwVvORnx4h0WP0oJL36R2DDJZmPcxugT6ob6',NULL,'admin',1);
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'bd_capacitaciones'
--

--
-- Dumping routines for database 'bd_capacitaciones'
--
...
-- Dump completed on 2023-05-23 21:52:10
